    ...
    return (
        <div className="container max-w-6xl mx-auto my-12 px-4">
            <header className="text-center mb-12">
                <h1 className="text-4xl font-bold text-blue-600">Valores de Rápido y Sabroso E.I.R.L.</h1>
            ...
            <section className="bg-gray-100 p-6 rounded-lg shadow-lg">
                <h2 className="text-2xl font-semibold text-blue-500">Principios y Valores del Negocio</h2>
                <p className="mt-4 text-lg">
                    ...
                    y valores que reflejan nuestra cultura organizacional y compromiso con la sociedad.
                </p>
            </section>
